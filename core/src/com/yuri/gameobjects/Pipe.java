...
public class Pipe extends Scrollable {
    ...
    public static final int SKULL_WIDTH = 21;
	...
	public Pipe(float x, float y, int width, int height, float scrollSpeed, float groupY) {
    ...
    public void update(float delta) {
        ...
        barDown.set(position.x, position.y + height + VERTICAL_GAP,
                width, groupY - (position.y + height + VERTICAL_GAP));
